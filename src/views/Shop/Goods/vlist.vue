  ...
  <div class="table-bg">
      <el-table  :data="goodslist">
          ...
          <el-table-column label="规格名" align="center">
              <template slot-scope="scope">
                  <el-tag v-for="(item,index) in specslist" :key="index"  type="success" v-if="item.id==scope.row.specsid">{{item.specsname}}</el-tag>
              </template>
          </el-table-column>
          <el-table-column label="规格值" align="center">
              <template slot-scope="scope">
                  <el-tag v-for="(item,index) in scope.row.specsattr" :key="index"  type="success" style="margin-right:5px">{{item}}</el-tag>
              </template>
          </el-table-column>
