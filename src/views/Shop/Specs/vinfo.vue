    ...
    <el-form :model="forminfo" ref="form" :rules="rules" label-width="140px">
        ...
        <el-form-item label="属性值" prop="attrs">
            <label v-for="(item,index) in list" :key="index">
                <el-input  style="display:inline-block;width:180px;margin-bottom:10px" v-model="item.value" placeholder="请输入属性值"></el-input>
                <el-button v-if="index==0"  type="primary" @click="addAttrs">添加属性</el-button>
                <el-button v-else  type="danger" @click="delAttrs(index)">删除属性</el-button><br>
            </label>
